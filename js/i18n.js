(function () {
  ...
  var translations = {
    th: {
      ...
      'hero.btnTiktok': 'ดู TikTok Profile',
      ...
      'about.statEngagement': 'Engagement Rate',
      'about.statAuthentic': 'Authentic Content',
      'about.statNote': 'แก้ตัวเลขได้ใน HTML',
      'about.statAuthenticNote': 'คอนเทนต์จริงใจ เป็นกันเอง',
      ...
      'collab.card1.desc': 'โพสต์หรือ Reels รีวิวสินค้า/บริการ สไตล์สนุก เป็นกันเอง เข้าถึง audience ได้จริง',
    ...
    en: {
      ...
      'hero.btnTiktok': 'View TikTok Profile',
      'hero.float1': 'Lifestyle',
      'hero.float2': 'Fun Content',
      'hero.float3': 'Digital Bestie',
      'about.label': 'About Us',
      ...
      'about.statEngagement': 'Engagement Rate',
      'about.statAuthentic': 'Authentic Content',
      'about.statNote': 'Update numbers in HTML',
      'about.statAuthenticNote': 'Genuine, friendly content',
      'collab.label': 'Collaboration',
      'collab.title': 'Collaboration Types',
      'collab.desc': 'We work with brands in many formats — flexible to your brief',
      'collab.card1.title': 'Sponsored Post / Reels',
      'collab.card1.desc': 'Fun, friendly posts or Reels reviewing your product or service — reaching audiences authentically',
      'collab.card2.title': 'Product Review / Unboxing',
      ...
      'why.card1.desc': 'Most followers are young people who love lifestyle, beauty, and fun content — perfect for brands targeting Gen Z & young millennials',
      'why.card2.title': 'Fun, Colorful Content',
      'why.card2.desc': 'Digital Bestie style content that is easy to read, cute, and distinctive — making your brand stand out in the feed',
      'why.card3.title': 'Responsive to Briefs',
      'why.card3.desc': 'Quick replies and flexible content tailored to your brand brief — professional and friendly collaboration',
      'cta.title': 'Interested in working together? Say hi! 💌',
      'cta.desc': 'Send us a DM on Instagram with your project brief — we will get back to you as soon as possible',
    ...
    zh: {
      ...
      'about.statFollowers': '粉丝数',
      'about.statEngagement': '互动率',
      'about.statAuthentic': '真实内容',
      'about.statNote': '可在 HTML 中更新数字',
      'about.statAuthenticNote': '真诚亲切的内容',
      'collab.label': 'Collaboration',
      'collab.title': '合作形式',
